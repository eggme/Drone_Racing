    ...
    public class PA_DroneAxisInputEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (daiScript.inputType == PA_DroneAxisInput.InputType.Desktop)
            {
                ...
                daiScript.toggleHeadless = EditorGUILayout.TextField("Toggle Headless Mode", "H");
                EditorGUI.EndDisabledGroup();
            }
            #endregion
            ...
            if (daiScript.inputType == PA_DroneAxisInput.InputType.Gamepad)
            {
                ...
                daiScript.toggleHeadless = EditorGUILayout.TextField("Toggle Headless Mode", "GP Button 6");
                EditorGUI.EndDisabledGroup();
            }
            #endregion
            ...
            if (daiScript.inputType == PA_DroneAxisInput.InputType.OpenVR)
            {
                ...
                daiScript.toggleHeadless = EditorGUILayout.TextField("Toggle Headless Mode", "OVR RightGrip");
                EditorGUI.EndDisabledGroup();
            }
            #endregion
            ...
            if (daiScript.inputType == PA_DroneAxisInput.InputType.Custom)
            {
                ...
                daiScript.toggleHeadless = EditorGUILayout.TextField("Toggle Headless Mode", daiScript.ctoggleHeadless);
            }
            #endregion
